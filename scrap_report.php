...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT timedate AS date, item_name,department,room,desktop_ID,identification_no,verifyed_by, Specification FROM scrap WHERE timedate BETWEEN '$fromDate' AND '$toDate'";
...
<div class="nav-option"><a href="scrap_report.php" class="nav-button" style="background-color: #3498db;">Scrap Report</a></div>
    ...
    <?php
        if (isset($result) && $result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<td>" . htmlspecialchars($row["verifyed_by"]) . "</td>";
